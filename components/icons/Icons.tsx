...
export const WaterDropIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 2.69l5.66 5.66a8 8 0 11-11.32 0L12 2.69zM12 21.17A9.992 9.992 0 005.64 8.35L12 2l6.36 6.35A9.992 9.992 0 0012 21.17z" />
  </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 0 1-4.874-1.944l.256-.256a1.125 1.125 0 0 1 1.59 0l.256.256c.43.43.954.743 1.514.932l.235.078a1.125 1.125 0 0 0 1.082-.188l.01-.007a48.74 48.74 0 0 0 5.252 0l.01.007a1.125 1.125 0 0 0 1.082.188l.235-.078c.56-.189 1.084-.502 1.514-.932l.256-.256a1.125 1.125 0 0 1 1.59 0l.256.256A9.75 9.75 0 0 1 16.5 18.75Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.75a3.75 3.75 0 0 0-7.5 0v3.75a3.75 3.75 0 0 0 7.5 0v-3.75Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75a3.75 3.75 0 0 1 7.5 0v3.75a3.75 3.75 0 0 1-7.5 0v-3.75Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75v3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 9.75a1.125 1.125 0 0 1 1.125-1.125h2.25a1.125 1.125 0 0 1 1.125 1.125v4.5A1.125 1.125 0 0 1 13.125 15h-2.25a1.125 1.125 0 0 1-1.125-1.125v-4.5Z" />
  </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52v16.5m-1.5-16.5v16.5m-1.5-16.5v16.5m-1.5-16.5v16.5m-1.5-16.5v16.5m-1.5-16.5v16.5M5.25 4.97c-1.01.143-2.01.317-3 .52m3-.52v16.5m1.5-16.5v16.5m1.5-16.5v16.5m1.5-16.5v16.5m1.5-16.5v16.5m1.5-16.5v16.5" />
  </svg>
);
...
export const MicrophoneIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m12 5.25v-1.5a6 6 0 0 0-12 0v1.5m12 0a9 9 0 1 1-12 0v-5.25a9 9 0 0 1 12 0v5.25Z" />
    </svg>
);
...
export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c.401-.044.812-.098 1.223-.169m1.223.169c.411.071.822.125 1.223.169m1.223.169a8.966 8.966 0 0 1 1.223-.169m0 0a8.966 8.966 0 0 0 1.223.169m-6.498-8.12A6.02 6.02 0 0 1 9 6.25a6 6 0 1 1 6 6c0 .54-.07 1.06-.2 1.567m-3.2 1.433a12.06 12.06 0 0 0-4.5 0" />
    </svg>
);

export const GlobeAltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c.504 0 1.002-.023 1.493-.067M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25a5.232 5.232 0 0 1-4.42-2.115M12 17.25a5.232 5.232 0 0 0 4.42-2.115M12 3c.18 0 .357.01.53.03m-1.06.06a5.25 5.25 0 0 0-4.42 2.115M12 3a5.25 5.25 0 0 1 4.42 2.115" />
    </svg>
);
...
export const ChatBubbleOvalLeftEllipsisIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-.388A5.887 5.887 0 0 1 5.25 12.75a.75.75 0 0 1 0-1.5 6.11 6.11 0 0 1 3.535-2.001A9.76 9.76 0 0 1 12 3c4.97 0 9 3.694 9 8.25Z" />
    </svg>
);
...
export const HandThumbUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.25c.806 0 1.533-.424 2.002-1.125.47-.701.502-1.591.09-2.322a3.75 3.75 0 0 0-5.404-1.125 3.75 3.75 0 0 0-1.125 5.404c.731.412 1.621.442 2.322.09.701-.47 1.125-1.196 1.125-2.002Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 10.25a2.25 2.25 0 0 1 2.25 2.25v.894a2.25 2.25 0 0 1-2.25 2.25H7.5a2.25 2.25 0 0 1-2.25-2.25V13.5a2.25 2.25 0 0 1 2.25-2.25h.75Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.25a2.25 2.25 0 0 1 2.25 2.25v.894a2.25 2.25 0 0 1-2.25 2.25h-.75a2.25 2.25 0 0 1-2.25-2.25V13.5a2.25 2.25 0 0 1 2.25-2.25h.75Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.25a2.25 2.25 0 0 1-2.25-2.25v-.894a2.25 2.25 0 0 1 2.25-2.25h.75a2.25 2.25 0 0 1 2.25 2.25v.894a2.25 2.25 0 0 1-2.25 2.25h-.75Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 15 12 18.75 15.75 15" />
    </svg>
);
...
export const GiftIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a2.25 2.25 0 0 1-2.25 2.25H5.25a2.25 2.25 0 0 1-2.25-2.25v-8.25a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 11.25Zm-18 0h18M12 9V5.25a2.25 2.25 0 0 1 2.25-2.25h.01a2.25 2.25 0 0 1 2.25 2.25v.01M12 9h.01M12 9V5.25a2.25 2.25 0 0 0-2.25-2.25h-.01A2.25 2.25 0 0 0 7.5 5.25v.01" />
    </svg>
);

export const ClipboardDocumentListIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 5.25 6h.75m1.5-1.5-2.475 2.475a.75.75 0 0 1-1.06 0L4.5 4.5m1.5-1.5V6a2.25 2.25 0 0 1-2.25 2.25H4.5m1.5-1.5h-.75a2.25 2.25 0 0 0-2.25 2.25V18a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 18V6.75a2.25 2.25 0 0 0-2.25-2.25h-.75m-1.5-1.5-2.475 2.475a.75.75 0 0 1-1.06 0L12 4.5m-1.5-1.5V6a2.25 2.25 0 0 1-2.25 2.25H6.75" />
  </svg>
);
...
export const IdentificationIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 8.25A2.25 2.25 0 0 1 12 6h0a2.25 2.25 0 0 1 2.25 2.25v.75a2.25 2.25 0 0 1-2.25 2.25h-.563a2.25 2.25 0 0 0-2.188 1.5H9" />
  </svg>
);
...
export const DocumentDuplicateIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a2.25 2.25 0 0 1-2.25-2.25V11.25m11.25 0c.377 0 .744.014 1.11.041m-1.11-.041a9.01 9.01 0 0 1-1.11.041m-1.328 5.455A9.033 9.033 0 0 1 12 15.75a9.033 9.033 0 0 1-1.328-.11M1.5 12a9.01 9.01 0 0 1 1.11.041" />
  </svg>
);

export const RocketLaunchIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.82m5.84-2.56a12.028 12.028 0 0 0-5.84 2.56m0-2.56V7.5a6 6 0 0 1 6 6v4.82a6 6 0 0 1-6-6Zm-6-1.5a12.028 12.028 0 0 1 5.84-2.56m0 2.56V7.5a6 6 0 0 0-6 6v4.82a6 6 0 0 0 6-6Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75v1.5m0-5.25v1.5m0 9v1.5m0-12.75a3 3 0 1 1 0 6 3 3 0 0 1 0-6Z" />
  </svg>
);

export const RectangleStackIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L2.25 12l4.179 2.25M6.429 14.25l5.571 3 5.571-3M6.429 14.25 2.25 12l4.179-2.25m11.142 0-5.571 3-5.571-3m11.142 0L21.75 12l-4.179-2.25m0 4.5 5.571-3-5.571-3" />
    </svg>
);

export const WrenchScrewdriverIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M1.5 12.75a1.125 1.125 0 0 1 1.125-1.125h18.75a1.125 1.125 0 0 1 0 2.25H2.625A1.125 1.125 0 0 1 1.5 12.75ZM7.5 3.75a1.125 1.125 0 0 1 1.125-1.125h6.75a1.125 1.125 0 0 1 0 2.25h-6.75A1.125 1.125 0 0 1 7.5 3.75ZM7.5 18.75a1.125 1.125 0 0 1 1.125-1.125h6.75a1.125 1.125 0 0 1 0 2.25h-6.75A1.125 1.125 0 0 1 7.5 18.75Z" />
    </svg>
);
...
export const UserMinusIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12H9m12 4.235v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766v-.11A6.375 6.375 0 0 1 12 12.75h5.25a1.125 1.125 0 0 1 1.125 1.125v.11a6.375 6.375 0 0 1-1.125 2.848M15 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Z" />
  </svg>
);
...
export const TierIcon: React.FC<{ icon: IconName; className?: string }> = ({ icon, className }) => {
